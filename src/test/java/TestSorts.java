...
public class TestSorts {
    ...
    public void testSortStringA(){
        ...
        String[] entry5 = {"каждый", "язык","програмирования", "предстовляет", "программу", "несколько", "типов" , "данных"};
        String[] exit5 = {"данных", "каждый","несколько", "предстовляет", "програмирования", "программу", "типов" , "язык"};
        //String[] exit5 = {"програмирования", "предстовляет","несколько ", "предстовляет ", "програмирования", "программу ", "типов" , "язык"};
        assertArrayEquals(exit5,sorts.sortSA(entry5));
    }
